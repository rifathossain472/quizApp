...
object LocalDataSource {
    ...
    val questionsComputerScience = mutableListOf<Quiz>(
        ...
        Quiz(
            "Question Number- 3",
            "Which part of a computer is responsible for arithmetic and logic operations?",
            listOf("RAM", "Hard Drive", "ALU", "Motherboard"),
            2
        ),
        Quiz(
            "Question Number- 4",
        ...
        Quiz(
            ...
            listOf("Hard Drive", "ROM", "RAM", "Cache"),
            2
        ),
        Quiz(
            "Question Number- 6",
            "Which of the following is a primary storage device?",
            listOf("Hard Disk", "DVD", "RAM", "USB Drive"),
            2
        ),
        Quiz(
            "Question Number- 7",
        ...
        Quiz(
            ...
            listOf("HTTP", "FTP", "SMTP", "POP3"),
            2
        ),
        Quiz(
            "Question Number- 10",
            "What is the smallest unit of data in a computer?",
            listOf("Bit", "Byte", "Nibble", "Word"),
            0
        )
    )
    ...
    val questionsCricket = mutableListOf<Quiz>(
        ...
        Quiz(
            "Question Number- 2",
            "What is the maximum number of overs in an ODI match?",
            listOf("20", "50", "100", "90"),
            1
        ),
        Quiz(
            ...
            listOf("Australia", "England", "India", "West Indies"),
            3
        ),
        Quiz(
            "Question Number- 4",
            "What is the name of the trophy awarded in Ashes series?",
            listOf("Champions Trophy", "Ashes Trophy", "Border-Gavaskar Trophy", "WTC Trophy"),
            1
        ),
        Quiz(
            "Question Number- 5",
            "What is the term for a bowler taking three wickets in three consecutive deliveries?",
            listOf("Maiden", "Duck", "Hat-trick", "Runout"),
            2
        ),
        Quiz(
            "Question Number- 6",
            "Which player has the highest individual score in ODI cricket?",
            listOf("Virat Kohli", "Chris Gayle", "Rohit Sharma", "Sachin Tendulkar"),
            2
        ),
        Quiz(
            "Question Number- 7",
            "What is the length of a cricket pitch?",
            listOf("18 yards", "20 yards", "22 yards", "24 yards"),
            2
        ),
        Quiz(
            "Question Number- 8",
            "Who is known as the 'God of Cricket'?",
            listOf("Virat Kohli", "MS Dhoni", "Sachin Tendulkar", "Ricky Ponting"),
            2
        ),
        Quiz(
            "Question Number- 9",
            "What is the term for scoring 100 runs in a single innings?",
            listOf("Century", "Half-century", "Double century", "Triple century"),
            0
        ),
        Quiz(
            "Question Number- 10",
            "Which bowler has taken the most wickets in Test cricket?",
            listOf("Muttiah Muralitharan", "Shane Warne", "Anil Kumble", "James Anderson"),
            0
        )
    )
    ...
    val questionsFootball = mutableListOf<Quiz>(
        Quiz(
            ...
            listOf("80 minutes", "90 minutes", "100 minutes", "120 minutes"),
            1
        ),
        Quiz(
            "Question Number- 2",
            "Which country won the FIFA World Cup in 2018?",
            listOf("Brazil", "Germany", "France", "Argentina"),
            2
        ),
        Quiz(
            "Question Number- 3",
            "What is the maximum number of players a team can have on the field?",
            listOf("9", "10", "11", "12"),
            2
        ),
        Quiz(
            "Question Number- 4",
            "What is the term for scoring three goals in a single match?",
            listOf("Double", "Brace", "Hat-trick", "Treble"),
            2
        ),
        Quiz(
            "Question Number- 5",
            "Which player has won the most Ballon d'Or awards?",
            listOf("Cristiano Ronaldo", "Lionel Messi", "Neymar", "Ronaldinho"),
            1
        ),
        Quiz(
            "Question Number- 6",
            "Which club is known as 'The Red Devils'?",
            listOf("Liverpool", "Arsenal", "Manchester United", "Chelsea"),
            2
        ),
        Quiz(
            "Question Number- 7",
            "Who is the all-time top scorer in international football?",
            listOf("Pele", "Cristiano Ronaldo", "Lionel Messi", "Ali Daei"),
            1
        ),
        Quiz(
            "Question Number- 8",
            "What is the standard size of a football field?",
            listOf("90x120 meters", "100x130 meters", "105x68 meters", "110x75 meters"),
            2
        ),
        Quiz(
            "Question Number- 9",
            "Which tournament is referred to as the 'Champions League'?",
            listOf("UEFA Champions League", "Europa League", "FA Cup", "La Liga"),
            0
        ),
        Quiz(
            "Question Number- 10",
            "Which team holds the record for most FIFA World Cup wins?",
            listOf("Italy", "Germany", "Brazil", "Argentina"),
            2
        )
    )
    ...
    val questionsMovies = mutableListOf<Quiz>(
        Quiz(
            ...
            listOf("Steven Spielberg", "Christopher Nolan", "James Cameron", "Martin Scorsese"),
            1
        ),
        Quiz(
            "Question Number- 2",
        ...
        Quiz(
            ...
            listOf("Chris Hemsworth", "Robert Downey Jr.", "Chris Evans", "Mark Ruffalo"),
            1
        ),
        Quiz(
            "Question Number- 4",
            "Which is the highest-grossing movie of all time?",
            listOf("Avatar", "Titanic", "Avengers: Endgame", "The Lion King"),
            0
        ),
        Quiz(
            "Question Number- 5",
            "What is the name of the wizarding school in Harry Potter?",
            listOf("Beauxbatons", "Hogwarts", "Durmstrang", "Ilvermorny"),
            1
        ),
        Quiz(
            "Question Number- 6",
            "Which actor played the Joker in 'The Dark Knight'?",
            listOf("Joaquin Phoenix", "Jack Nicholson", "Heath Ledger", "Jared Leto"),
            2
        ),
        Quiz(
            "Question Number- 7",
            "Which movie series features a ring that must be destroyed?",
            listOf("Star Wars", "Harry Potter", "The Lord of the Rings", "The Matrix"),
            2
        ),
        Quiz(
            "Question Number- 8",
        ...
        Quiz(
            "Question Number- 9",
            "Which animated movie features the character 'Simba'?",
            listOf("Finding Nemo", "The Lion King", "Shrek", "Toy Story"),
            1
        ),
        Quiz(
            "Question Number- 10",
    ...
    val questionsProgramming = mutableListOf<Quiz>(
        Quiz(
            "Question Number- 1",
            "What is the extension of a Kotlin file?",
            listOf(".java", ".kt", ".kotlin", ".py"),
            1
        ),
        Quiz(
            "Question Number- 2",
            "Which programming language is known as the backbone of Android development?",
        ...
        Quiz(
            ...
            listOf("Swift", "Kotlin", "Java", "Python"),
            0
        ),
        Quiz(
            "Question Number- 5",
        ...
        Quiz(
            "Question Number- 7",
            "Which of the following is a valid loop in Kotlin?",
            listOf("for", "foreach", "loop", "do while"),
            0
        ),
        Quiz(
            "Question Number- 8",
            "Which symbol is used to comment in Kotlin?",
            listOf("//", "/* */", "#", "All of the above"),
            3
        ),
        Quiz(
            "Question Number- 9",
            "What is the default value of a boolean in Kotlin?",
    ...
    val questionsMathematics = mutableListOf<Quiz>(
        ...
        Quiz(
            ...
            listOf("0", "1", "-1", "Undefined"),
            1
        ),
        Quiz(
            "Question Number- 9",
            "What is the product of 13 and 6?",
            listOf("65", "72", "78", "84"),
            2
        ),
    ...
    val questionsPhysics = mutableListOf<Quiz>(
        Quiz(
            ...
            listOf("300,000 km/s", "150,000 km/s", "400,000 km/s", "100,000 km/s"),
            0
        ),
        Quiz(
            "Question Number- 2",
            "Who formulated the law of gravitation?",
            listOf("Newton", "Einstein", "Galileo", "Kepler"),
            0
        ),
        Quiz(
            "Question Number- 3",
            "What is the SI unit of force?",
            listOf("Pascal", "Newton", "Joule", "Watt"),
            1
        ),
        Quiz(
            "Question Number- 4",
            "What is the acceleration due to gravity on Earth?",
            listOf("8.9 m/s²", "9.8 m/s²", "10 m/s²", "11 m/s²"),
            1
        ),
        Quiz(
            "Question Number- 5",
            "Which color of light has the shortest wavelength?",
            listOf("Red", "Blue", "Violet", "Green"),
            2
        ),
        Quiz(
            "Question Number- 6",
        ...
        Quiz(
            ...
            listOf("Marie Curie", "Henri Becquerel", "Rutherford", "Einstein"),
            1
        ),
        Quiz(
            "Question Number- 10",
            "What type of lens is used to correct myopia?",
            listOf("Convex", "Concave", "Cylindrical", "Spherical"),
            1
        )
    )
    ...
    val questionsChemistry = mutableListOf<Quiz>(
        ...
        Quiz(
            ...
            listOf("Carbon dioxide", "Oxygen", "Nitrogen", "Methane"),
            1
        ),
        Quiz(
            "Question Number- 4",
        ...
        Quiz(
            ...
            listOf("H2O", "CO2", "O2", "H2O2"),
            0
        ),
        Quiz(
            "Question Number- 7",
            "Which acid is found in lemons?",
            listOf("Acetic acid", "Citric acid", "Lactic acid", "Sulfuric acid"),
            1
        ),
        Quiz(
            "Question Number- 8",
            "What is the process of turning solid directly into gas?",
            listOf("Melting", "Evaporation", "Sublimation", "Condensation"),
            2
        ),
        Quiz(
            "Question Number- 9",
            "Which element has the symbol 'Na'?",
            listOf("Nitrogen", "Sodium", "Neon", "Nickel"),
            1
        ),
        Quiz(
            "Question Number- 10",
            "What is the molecular formula of glucose?",
            listOf("C6H6", "C6H12O6", "CH4", "C12H22O11"),
            1
        )
    )
    ...
    val questionsBiology = mutableListOf<Quiz>(
        Quiz(
            ...
            listOf("Heart", "Kidney", "Liver", "Lungs"),
            1
        ),
        Quiz(
            "Question Number- 2",
            "What is the basic unit of life?",
            listOf("Tissue", "Organ", "Cell", "Molecule"),
            2
        ),
        Quiz(
            "Question Number- 3",
        ...
        Quiz(
            ...
            listOf("Liver", "Kidney", "Pancreas", "Stomach"),
            2
        ),
        Quiz(
            "Question Number- 5",
            "What is the largest organ in the human body?",
            listOf("Heart", "Skin", "Liver", "Lungs"),
            1
        ),
        Quiz(
            "Question Number- 6",
            "What type of blood cells fight infections?",
            listOf("Red blood cells", "White blood cells", "Platelets", "Plasma"),
            1
        ),
        Quiz(
            "Question Number- 7",
            "What is the function of hemoglobin?",
            listOf("Transport oxygen", "Digest food", "Fight infections", "Clot blood"),
            0
        ),
        Quiz(
            "Question Number- 8",
        ...
        Quiz(
            ...
            listOf("Stapes", "Femur", "Radius", "Humerus"),
            0
        ),
        Quiz(
            "Question Number- 10",
            "What is the process by which plants make food?",
            listOf("Respiration", "Photosynthesis", "Digestion", "Absorption"),
            1
        )
    )
    ...
    val questionsEconomics = mutableListOf<Quiz>(
        ...
        Quiz(
            ...
            listOf("Unlimited resources", "Scarcity of resources", "Inflation", "Globalization"),
            1
        ),
        Quiz(
            "Question Number- 3",
            "Which type of market has only one seller?",
            listOf("Monopoly", "Oligopoly", "Perfect competition", "Monopsony"),
            0
        ),
        Quiz(
            "Question Number- 4",
        ...
        Quiz(
            ...
            listOf(
                ...
                "An increase in overall price levels",
                "Stable price levels",
                "None of the above"
            ),
            1
        ...
        Quiz(
            ...
            listOf(
                ...
                "A good that has no alternative",
                "A luxury good"
            ),
            0
        ),
        Quiz(
            ...
            listOf(
                ...
                "The quantity of a product supplied"
            ),
            2
        ),
        Quiz(
            ...
            listOf("Store of value", "Unit of account", "Medium of exchange", "All of the above"),
            3
        ),
        Quiz(
            "Question Number- 10",
            ...
            listOf(
                ...
                "The total expense of a project",
